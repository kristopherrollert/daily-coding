...
//
// My interesting way was alternating between green, red, and blue lines
package main
...
const (
	blackIndex = 3 // first color in palette
	redIndex   = 0 // next color in palette
	blueIndex  = 1
	greenIndex = 2
)
